...
public class ViolationOfLawDataModel extends LazyDataModel<ViolationOfLaw> {
	...
	public ViolationOfLawDataModel(List<FilterExample> filters, ViolationOfLawService service) {
	...
	@Override
	public Object getRowKey(ViolationOfLaw entity) {
		return entity.getId();
	}
	
	@Override
	public ViolationOfLaw getRowData(String key) {
		try {
	...
	@Override	
	 public List<ViolationOfLaw> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
