...
public class ApplicationsDataModel extends LazyDataModel<Applications> {
	...
	public ApplicationsDataModel(List<FilterExample> filters, ApplicationsService service) {
	...
	@Override
	public Object getRowKey(Applications entity) {
		return entity.getId();
	}
	
	@Override
	public Applications getRowData(String key) {
		try {
	...
	@Override	
	 public List<Applications> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
