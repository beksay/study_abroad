...
public class CertificateDataModel extends LazyDataModel<Certificate> {
	...
	public CertificateDataModel(List<FilterExample> filters, CertificateService service) {
	...
	@Override
	public Object getRowKey(Certificate entity) {
		return entity.getId();
	}
	
	@Override
	public Certificate getRowData(String key) {
		try {
