...
public class UniversitiesDataModel extends LazyDataModel<Universities> {
	...
	public UniversitiesDataModel(List<FilterExample> filters, UniversitiesService service) {
	...
	@Override
	public Object getRowKey(Universities entity) {
		return entity.getId();
	}
	
	@Override
	public Universities getRowData(String key) {
		try {
	...
	@Override	
	 public List<Universities> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
