...
public class EntryPointDataModel extends LazyDataModel<EntryPoint> {
	...
	public EntryPointDataModel(List<FilterExample> filters, EntryPointService service) {
	...
	@Override
	public Object getRowKey(EntryPoint entity) {
		return entity.getId();
	}
	
	@Override
	public EntryPoint getRowData(String key) {
		try {
	...
	@Override	
	 public List<EntryPoint> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
