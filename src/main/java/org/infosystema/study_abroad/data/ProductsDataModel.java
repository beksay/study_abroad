...
public class ProductsDataModel extends LazyDataModel<Products> {
	...
	public ProductsDataModel(List<FilterExample> filters, ProductsService service) {
	...
	@Override
	public Object getRowKey(Products entity) {
		return entity.getId();
	}
	
	@Override
	public Products getRowData(String key) {
		try {
