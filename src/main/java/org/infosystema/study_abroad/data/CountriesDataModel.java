...
public class CountriesDataModel extends LazyDataModel<Countries> {
	...
	public CountriesDataModel(List<FilterExample> filters, CountriesService service) {
	...
	@Override
	public Object getRowKey(Countries entity) {
		return entity.getId();
	}
	
	@Override
	public Countries getRowData(String key) {
		try {
	...
	@Override	
	 public List<Countries> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
