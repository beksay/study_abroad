...
import org.infosystema.study_abroad.data.EntryPointDataModel;
...
public class EntryPointList implements Serializable {
	...
	public void filterData(){	
		...
		model = new EntryPointDataModel(filters, service);	
	}
	
	public EntryPointDataModel getModel() {
		return model;
	}
	
	public void setModel(EntryPointDataModel model) {
		this.model = model;
	}
	...
	public void restoreState() {
    	HttpServletRequest request = (HttpServletRequest)FacesContext.getCurrentInstance().getExternalContext().getRequest();
		HttpSession session = request.getSession();
		model = (EntryPointDataModel) session.getAttribute("model");
