...
import org.infosystema.study_abroad.data.OrganizationDataModel;
...
public class OrganizationList implements Serializable {
	...
	public void filterData(){	
		...
		model = new OrganizationDataModel(filters, service);	
	}
	
	public OrganizationDataModel getModel() {
		return model;
	}
	
	public void setModel(OrganizationDataModel model) {
		this.model = model;
	}
	...
	public void restoreState() {
    	HttpServletRequest request = (HttpServletRequest)FacesContext.getCurrentInstance().getExternalContext().getRequest();
		HttpSession session = request.getSession();
		model = (OrganizationDataModel) session.getAttribute("model");
