...
public abstract class BaseReportController1 {	
	
	protected Connection connection;

	public BaseReportController1() {
	}
	...
	protected JasperPrint generateJasperPrint(Map<String, Object> map, String path){
		...
		try {	//System.out.println("***connection***");
	...
	private InputStream getStreamFromReports(String filename) {
		...
		System.out.println("load jasper from test" + "/WEB-INF/reports/" + filename);
		return externalContext.getResourceAsStream("/WEB-INF/reports/" + filename);
	}
