...
public class Ds160Controller extends Conversational {
	...
	public String edit(Ds160 module) {
	...
	public Ds160 getModule() {
		return module;
	}
	
	public void setModule(Ds160 module) {
		this.module = module;
	}
