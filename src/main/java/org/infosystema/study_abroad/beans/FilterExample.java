...
public class FilterExample implements Serializable {
	...
	public String query(String entity, int index) {
		if(length){
			return " length(" + getEntityName(entity) + getProperty() + ") " + getOperation(getConstants()) + " :value" + index; 
		...
		if (value!=null){
			if(getConstants()!=InequalityConstants.MEMBER_OF)
				{return insensitive ? " UPPER(" + getEntityName(entity) + getProperty() + ") " + getOperation(getConstants()) + " UPPER(:value" + index + ")"
						: " " + getEntityName(entity) + getProperty() + " " + getOperation(getConstants()) + " :value" + index;}
			else
				{return insensitive ? " UPPER(" + getEntityName(entity) + getProperty() + ") " + getOperation(getConstants()) + " UPPER(:value" + index + ")"
					: " :value" + index+ " " + getOperation(getConstants()) + " " + getEntityName(entity) + getProperty() ;}
		}
		else
			return insensitive ? " UPPER(" + getEntityName(entity) + getProperty() + ") " + getOperation(getConstants())
					: " " + getEntityName(entity) + getProperty() + " " + getOperation(getConstants()) ;
			
	}
	
	private String getEntityName(String entity) {
		return getProperty().contains(".") ? "" : entity + ".";
	}
