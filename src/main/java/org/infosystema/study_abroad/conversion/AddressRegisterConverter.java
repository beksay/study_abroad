...
@FacesConverter(value="addressRegisterConverter")
public class AddressRegisterConverter implements Converter<Object> {
	
	private static final Map<Object, String> caches = new HashMap<>();
