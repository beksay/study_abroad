...
import org.infosystema.study_abroad.util.Digest;
import org.infosystema.study_abroad.util.Krypto;
import org.infosystema.study_abroad.util.PasswordEncryptionService;
...
public class LoginUtil implements Serializable {
    ...
    public static final String CURRENT_USER_ACCESS_TOKEN = "org.infosystema.study_abroad.current_user_access_token";
    public static final String CURRENT_USER_PIVILAGES_SESSION_KEY = "org.infosystema.study_abroad.current_user_privilages_session_key";
    public static final String AUTH_TYPE = "org.infosystema.study_abroad.auth_type";
    public static final String SESSION_ID = "org.infosystema.study_abroad.session_id";
    public static final String SESSION_INN = "org.infosystema.study_abroad.session_inn";
