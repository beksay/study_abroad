...
public class Configuration {
	...
	private static final String SETTING_FILE = "/opt/settings/iselect_setting.properties";
	...
	private void init(){
		try {
			...
			InputStream stream = file.exists() && file.isFile() ? new FileInputStream(file) 
				: getClass().getClassLoader().getResourceAsStream("iselect_setting.properties");
