...
public class QuarantineObjectDataModel extends LazyDataModel<QuarantineObject> {
	...
	public QuarantineObjectDataModel(List<FilterExample> filters, QuarantineObjectService service) {
	...
	@Override
	public Object getRowKey(QuarantineObject entity) {
		return entity.getId();
	}
	
	@Override
	public QuarantineObject getRowData(String key) {
		try {
	...
	@Override	
	 public List<QuarantineObject> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
