...
public class InspectionDataModel extends LazyDataModel<Inspection> {
	...
	public InspectionDataModel(List<FilterExample> filters, InspectionService service) {
	...
	@Override
	public Inspection getRowData(String key) {
		try {
